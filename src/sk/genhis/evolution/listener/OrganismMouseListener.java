...
public final class OrganismMouseListener implements MouseListener {
	...
	public void mouseEntered(MouseEvent e) {
		...
		Evolution.get().lblInfo.setText("ID: " + o.id + " | " + Evolution.get().slcDisplay.getSelectedItem() + ": " + o.getAbilityById(Evolution.get().slcDisplay.getSelectedIndex()) + " | Skóre: " + o.getScore());
	}
	
	@Override
	public void mouseExited(MouseEvent e) {
		Evolution.get().lblInfo.setText("Prejdi myšou po organizme pre dodatoèné informácie");
	}
